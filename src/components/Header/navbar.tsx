...
const Navbar = () => {
  ...
  return (
    <header className="lg:py-4 h-20 lg:px-6 py-3 px-4 shadow-md bg-white backdrop-blur-xl z-40 dark:bg-slate-900 static ">
      <div className="max-w-[1440px] mx-auto">
        <div className="flex items-center justify-between">
          ...
          <div className="relative overflow-visible z-50">
            ...
            {/* Dropdown Menu */}
            {dropdownOpen && (
              <div className="absolute right-0 mt-2 bg-white text-black shadow-lg p-3 rounded-md w-40 z-50">
